...
public class ReplaceMobileCodeMethod implements CodeMethod {

	JMAccountService accountService = Aop.get(JMAccountService.class);

	@Override
	public JMResult check(String mail, int registerType) {
		return JMResultUtil.success(RedisInformation.MOBILE_REPLACE_CODE, PromptInformationEnum.SUCCESS);
	}
