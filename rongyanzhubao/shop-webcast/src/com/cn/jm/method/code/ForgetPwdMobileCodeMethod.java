 ...
 *
 */
public class ForgetPwdMobileCodeMethod implements CodeMethod {

	JMAccountService accountService = Aop.get(JMAccountService.class);

	@Override
	public JMResult check(String m, int registerType) {
		return accountService.isExistence("mobile =", m, registerType)
				? JMResultUtil.success(RedisInformation.MOBILE_FORGET_CODE, PromptInformationEnum.SUCCESS)
