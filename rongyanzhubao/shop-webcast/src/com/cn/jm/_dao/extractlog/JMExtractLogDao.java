...
package com.cn.jm._dao.extractlog;
...
public class JMExtractLogDao extends ExtractLogDao{
	...
	public Page<ExtractLog> page(Integer pageNumber, Integer pageSize, String mobile, String nick, Integer state,
		...
		SqlUtil.addBetweenTime(fromSql, applyStartTime, applyEndTime, " AND el.createTime");
		SqlUtil.addBetweenTime(fromSql, examineStartTime, examineEndTime, " AND el.examineTime");
	...
	public List<ExtractLog> list(String mobile, String nick, Integer state,
			String applyStartTime, String applyEndTime, String examineStartTime, String examineEndTime, boolean isCache){
		StringBuilder selectSql = new StringBuilder("SELECT el.*,au.mobile,au.nick ");
		StringBuilder fromSql = new StringBuilder(" FROM ");
		fromSql.append(tableName + " el");
		...
		String strFromSql = SqlUtil.getSql(fromSql);
		String strSelectSql = selectSql.toString();
		return isCache ? list(strSelectSql + strFromSql, true) : list(strSelectSql + strFromSql, false);
	}
}
