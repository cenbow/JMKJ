...
public class JMTableRelate {
	...
	public static void create() {
		...
		tableMap.put("tag", createTag());
		tableMap.put("meta", createMeta());
		
		
		//social
		tableMap.put("social", createSocial());
	}
	...
	private static JMMainTable createTag() {
		List<JMSubTable> subTableList = new ArrayList<JMSubTable>();
		subTableList.add(new JMSubTable("tb_article_tag", "", JMSubTable.CASCADE));
		
		JMMainTable table = new JMMainTable();
		table.setTableName("tb_tag");
		table.setPrimaryKeyName("id");
		table.setSubKeyName("tagId");
		table.setSubTableNameList(subTableList);
		return table;
	}
	...
	private static JMMainTable createSocial() {
		List<JMSubTable> subTableList = new ArrayList<JMSubTable>();
		subTableList.add(new JMSubTable("social_topic", "", JMSubTable.CASCADE));
		
		JMMainTable table = new JMMainTable();
		table.setTableName("social_comment");
		table.setPrimaryKeyName("id");
