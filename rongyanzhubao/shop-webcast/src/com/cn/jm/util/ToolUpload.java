...
public class ToolUpload extends JMUploadKit{
	...
	public static List<String> batchUploadOSSImg(int length, Controller controller, String param, String path) {
		List<String> list = new ArrayList<>();

		for (int i = 1; i <= length; ++i) {
			String image = uploadOSSImg(controller, param + i, path);
			if (image != null) {
				list.add(image);
			}else {
				list.add("");
