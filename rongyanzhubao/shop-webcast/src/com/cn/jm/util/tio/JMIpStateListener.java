 ...
 *
 */
public class JMIpStateListener implements IpStatListener {
	@SuppressWarnings("unused")
	private static Logger log = LoggerFactory.getLogger(JMIpStateListener.class);

	public static final JMIpStateListener me = new JMIpStateListener();

	/**
	 * 
	 */
	private JMIpStateListener() {
	}
