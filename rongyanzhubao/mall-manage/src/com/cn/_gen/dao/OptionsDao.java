...
import com.cn._gen.model.Options;
 ...
 */
public class OptionsDao extends JMBaseDao {
	
	public static final Options dao = new Options().dao();
	public static final String cacheName = "options";
	public static final String tableName = "tb_options";
	
	public List<Options> list(boolean useCache) {
		return list("",null,null,null,"id",JMBaseDao.DESC,useCache);
	} 
	
	public List<Options> list(String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, null, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Options> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Options> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, likepm, "", orderField, orderDirection, useCache);
	}
	
	public List<Options> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField,String orderDirection,boolean useCache) {
	...
	public List<Options> list(String sql,boolean useCache) {
		return list(tableName, dao, cacheName, sql, useCache);
	}
	
	public Page<Options> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String startTime,String endTime,String orderField,String orderDirection, boolean useCache) {
	...
	public Page<Options> page(int pageNumber, int pageSize,boolean useCache) {
		return page(pageNumber, pageSize, "", null, null, null, "", "id",DESC, useCache);
	}
	
	public Page<Options> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, null, null, orderField, orderDirection, useCache);
	}
	
	public Page<Options> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, null, orderField, orderDirection, useCache);
	}

	public Page<Options> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection, boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, likepm, "", orderField,orderDirection, useCache);
	}
	
	public Page<Options> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField, String orderDirection,boolean useCache) {
	...
	public Page<Options> page(int pageNumber, int pageSize,String columns,String where ,String orderField, String orderDirection,boolean useCache) {
		return page(tableName, dao, cacheName, pageNumber, pageSize, columns, where, orderField, orderDirection, useCache);
	}
	
	public Page<Options> page(int pageNumber, int pageSize,String columns,String from,boolean useCache) {
		return page(tableName, dao, cacheName, pageNumber, pageSize, columns, from, useCache);
	}

	public Options getById(Integer id) {
		return getById(id, true);
	}
	
	public Options getById(Integer id,boolean useCache) {
		return getById("", id, useCache);
	}
	
	@SuppressWarnings("unchecked")
	public Options getById(String columns,Integer id,boolean useCache) {
	...
	public Options get(HashMap<String, Object> param,boolean useCache) {
		return get("", param, useCache);
	}
	
	public Options get(String columns,HashMap<String, Object> param,boolean useCache) {
		StringBuffer format = new StringBuffer("SELECT ");
		if (JMToolString.isEmpty(columns)) {
			format.append(" * ");
		}else {
	...
	public Options get(String sql,boolean useCache) {
		if (useCache) {
	...
	public boolean save(Options options) {
		return Db.tx(new IAtom() {
			...
			public boolean run() throws SQLException {
				boolean result =  options.save();
				if (result) {
					clearCache();
					result = isave(options, result);
				}
				return result;
			}
		});
	...
	public boolean saves(List<Options> optionsList) {
		int[] results = Db.use("base").batchSave(optionsList, 2000);
		clearCache();
		return isaves(optionsList, results);
	}
	...
	public boolean update(Options options) {
		return Db.tx(new IAtom() {
			@Override
			public boolean run() throws SQLException {
				boolean result =  options.update();
				if (result) {
					clearCache();
					result = iupdate(options, result);
				}
				return result;
			}
		});
	...
	public boolean updates(List<Options> optionsList) {
		int[] results = Db.use("base").batchUpdate(optionsList, 2000);
		clearCache();
		return iupdates(optionsList, results);
	}


	public boolean delete(Options options) {
		return deleteById(options.getId());
	}
	...
	public boolean delete(List<Options> optionsList) {
		if(optionsList.isEmpty()){
			return false;
		}
		List<Integer> ids = new ArrayList<Integer>();
		for (int i = 0; i < optionsList.size(); i++) {
			ids.add(optionsList.get(i).getId());
		}
	...
	public List<Options> list(HashMap<String, Object> param,String orderDirection) {
		return list(param,"id",orderDirection);
	}

	public List<Options> list(HashMap<String, Object> param,String orderField,String orderDirection) {
