 ...
 */
public class PowerDao extends JMBaseDao {
	
	public static final Power dao = new Power().dao();
	public static final String cacheName = "power";
	public static final String tableName = "system_power";
	
	public List<Power> list(boolean useCache) {
		return list("",null,null,null,"id",JMBaseDao.DESC,useCache);
	} 
	
	public List<Power> list(String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, null, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Power> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Power> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, likepm, "", orderField, orderDirection, useCache);
	}
	
	public List<Power> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField,String orderDirection,boolean useCache) {
	...
	public List<Power> list(String sql,boolean useCache) {
		return list(tableName, dao, cacheName, sql, useCache);
	}
	
	public Page<Power> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String startTime,String endTime,String orderField,String orderDirection, boolean useCache) {
	...
	public Page<Power> page(int pageNumber, int pageSize,boolean useCache) {
		return page(pageNumber, pageSize, "", null, null, null, "", "id",DESC, useCache);
	}
	
	public Page<Power> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, null, null, orderField, orderDirection, useCache);
	}
	
	public Page<Power> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, null, orderField, orderDirection, useCache);
	}

	public Page<Power> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection, boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, likepm, "", orderField,orderDirection, useCache);
	}
	
	public Page<Power> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField, String orderDirection,boolean useCache) {
	...
	public Page<Power> page(int pageNumber, int pageSize,String columns,String where ,String orderField, String orderDirection,boolean useCache) {
		return page(tableName, dao, cacheName, pageNumber, pageSize, columns, where, orderField, orderDirection, useCache);
	}
	
	public Page<Power> page(int pageNumber, int pageSize,String columns,String from,boolean useCache) {
	...
	public Power getById(Integer id,boolean useCache) {
		return getById("", id, useCache);
	}
	
	@SuppressWarnings("unchecked")
	public Power getById(String columns,Integer id,boolean useCache) {
	...
	public Power get(HashMap<String, Object> param,boolean useCache) {
		return get("", param, useCache);
	}
	
	public Power get(String columns,HashMap<String, Object> param,boolean useCache) {
		StringBuffer format = new StringBuffer("SELECT ");
		if (JMToolString.isEmpty(columns)) {
			format.append(" * ");
		}else {
	...
	public Power get(String sql,boolean useCache) {
		if (useCache) {
	...
	public boolean save(Power power) {
		return Db.tx(new IAtom() {
			...
			public boolean run() throws SQLException {
				boolean result =  power.save();
				if (result) {
					clearCache();
					result = isave(power, result);
				}
				return result;
			}
		});
	...
	public boolean saves(List<Power> powerList) {
		int[] results = Db.use("base").batchSave(powerList, 2000);
		clearCache();
		return isaves(powerList, results);
	}
	...
	public boolean update(Power power) {
		return Db.tx(new IAtom() {
			@Override
			public boolean run() throws SQLException {
				boolean result =  power.update();
				if (result) {
					clearCache();
					result = iupdate(power, result);
				}
				return result;
			}
		});
	...
	public boolean updates(List<Power> powerList) {
		int[] results = Db.use("base").batchUpdate(powerList, 2000);
		clearCache();
		return iupdates(powerList, results);
	}


	public boolean delete(Power power) {
		return deleteById(power.getId());
	}
	...
	public boolean delete(List<Power> powerList) {
		if(powerList.isEmpty()){
			return false;
		}
		List<Integer> ids = new ArrayList<Integer>();
		for (int i = 0; i < powerList.size(); i++) {
			ids.add(powerList.get(i).getId());
		}
	...
	public List<Power> list(HashMap<String, Object> param,String orderDirection) {
		return list(param,"id",orderDirection);
	}

	public List<Power> list(HashMap<String, Object> param,String orderField,String orderDirection) {
