 ...
 */
public class AccountDao extends JMBaseDao {
	...
	public List<Account> list(boolean useCache) {
		return list("",null,null,null,"id",JMBaseDao.DESC,useCache);
	} 
	
	public List<Account> list(String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, null, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Account> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Account> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, likepm, "", orderField, orderDirection, useCache);
	}
	
	public List<Account> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField,String orderDirection,boolean useCache) {
	...
	public List<Account> list(String sql,boolean useCache) {
	...
	public Page<Account> page(int pageNumber, int pageSize,boolean useCache) {
		return page(pageNumber, pageSize, "", null, null, null, "", "id",DESC, useCache);
	}
	
	public Page<Account> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, null, null, orderField, orderDirection, useCache);
	}
	
	public Page<Account> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
	...
	public Page<Account> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField, String orderDirection,boolean useCache) {
	...
	public Page<Account> page(int pageNumber, int pageSize,String columns,String where ,String orderField, String orderDirection,boolean useCache) {
		return page(tableName, dao, cacheName, pageNumber, pageSize, columns, where, orderField, orderDirection, useCache);
	}
	
	public Page<Account> page(int pageNumber, int pageSize,String columns,String from,boolean useCache) {
	...
	public Account getById(Integer id,boolean useCache) {
		return getById("", id, useCache);
	}
	
	@SuppressWarnings("unchecked")
	public Account getById(String columns,Integer id,boolean useCache) {
	...
	public Account get(HashMap<String, Object> param,boolean useCache) {
		return get("", param, useCache);
	}
	
	public Account get(String columns,HashMap<String, Object> param,boolean useCache) {
		StringBuffer format = new StringBuffer("SELECT ");
		if (JMToolString.isEmpty(columns)) {
			format.append(" * ");
		}else {
	...
	public Account get(String sql,boolean useCache) {
		if (useCache) {
	...
	public boolean saves(List<Account> accountList) {
		int[] results = Db.use("base").batchSave(accountList, 2000);
		clearCache();
		return isaves(accountList, results);
	}
	...
	public boolean update(Account account) {
		return Db.tx(new IAtom() {
			@Override
			public boolean run() throws SQLException {
				boolean result =  account.update();
				if (result) {
					clearCache();
					result = iupdate(account, result);
				}
				return result;
			}
		});
	...
	public boolean updates(List<Account> accountList) {
		int[] results = Db.use("base").batchUpdate(accountList, 2000);
		clearCache();
		return iupdates(accountList, results);
	}
	...
	public boolean delete(List<Account> accountList) {
		if(accountList.isEmpty()){
			return false;
		}
		List<Integer> ids = new ArrayList<Integer>();
		for (int i = 0; i < accountList.size(); i++) {
			ids.add(accountList.get(i).getId());
		}
	...
	public List<Account> list(HashMap<String, Object> param,String orderDirection) {
		return list(param,"id",orderDirection);
	}

	public List<Account> list(HashMap<String, Object> param,String orderField,String orderDirection) {
