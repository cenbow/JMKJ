 ...
 */
public class MenuDao extends JMBaseDao {
	
	public static final Menu dao = new Menu().dao();
	public static final String cacheName = "menu";
	public static final String tableName = "system_menu";
	
	public List<Menu> list(boolean useCache) {
		return list("",null,null,null,"id",JMBaseDao.DESC,useCache);
	} 
	
	public List<Menu> list(String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, null, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Menu> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Menu> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, likepm, "", orderField, orderDirection, useCache);
	}
	
	public List<Menu> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField,String orderDirection,boolean useCache) {
	...
	public List<Menu> list(String sql,boolean useCache) {
		return list(tableName, dao, cacheName, sql, useCache);
	}
	
	public Page<Menu> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String startTime,String endTime,String orderField,String orderDirection, boolean useCache) {
	...
	public Page<Menu> page(int pageNumber, int pageSize,boolean useCache) {
		return page(pageNumber, pageSize, "", null, null, null, "", "id",DESC, useCache);
	}
	
	public Page<Menu> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, null, null, orderField, orderDirection, useCache);
	}
	
	public Page<Menu> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, null, orderField, orderDirection, useCache);
	}

	public Page<Menu> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection, boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, likepm, "", orderField,orderDirection, useCache);
	}
	
	public Page<Menu> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField, String orderDirection,boolean useCache) {
	...
	public Page<Menu> page(int pageNumber, int pageSize,String columns,String where ,String orderField, String orderDirection,boolean useCache) {
		return page(tableName, dao, cacheName, pageNumber, pageSize, columns, where, orderField, orderDirection, useCache);
	}
	
	public Page<Menu> page(int pageNumber, int pageSize,String columns,String from,boolean useCache) {
	...
	public Menu getById(Integer id,boolean useCache) {
		return getById("", id, useCache);
	}
	
	@SuppressWarnings("unchecked")
	public Menu getById(String columns,Integer id,boolean useCache) {
	...
	public Menu get(HashMap<String, Object> param,boolean useCache) {
		return get("", param, useCache);
	}
	
	public Menu get(String columns,HashMap<String, Object> param,boolean useCache) {
		StringBuffer format = new StringBuffer("SELECT ");
		if (JMToolString.isEmpty(columns)) {
			format.append(" * ");
		}else {
	...
	public Menu get(String sql,boolean useCache) {
		if (useCache) {
	...
	public boolean save(Menu menu) {
		return Db.tx(new IAtom() {
			...
			public boolean run() throws SQLException {
				boolean result =  menu.save();
				if (result) {
					clearCache();
					result = isave(menu, result);
				}
				return result;
			}
		});
	...
	public boolean saves(List<Menu> menuList) {
		int[] results = Db.use("base").batchSave(menuList, 2000);
		clearCache();
		return isaves(menuList, results);
	}
	...
	public boolean update(Menu menu) {
		return Db.tx(new IAtom() {
			@Override
			public boolean run() throws SQLException {
				boolean result =  menu.update();
				if (result) {
					clearCache();
					result = iupdate(menu, result);
				}
				return result;
			}
		});
	...
	public boolean updates(List<Menu> menuList) {
		int[] results = Db.use("base").batchUpdate(menuList, 2000);
		clearCache();
		return iupdates(menuList, results);
	}


	public boolean delete(Menu menu) {
		return deleteById(menu.getId());
	}
	...
	public boolean delete(List<Menu> menuList) {
		if(menuList.isEmpty()){
			return false;
		}
		List<Integer> ids = new ArrayList<Integer>();
		for (int i = 0; i < menuList.size(); i++) {
			ids.add(menuList.get(i).getId());
		}
	...
	public List<Menu> list(HashMap<String, Object> param,String orderDirection) {
		return list(param,"id",orderDirection);
	}

	public List<Menu> list(HashMap<String, Object> param,String orderField,String orderDirection) {
