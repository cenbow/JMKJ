 ...
 */
public class AreaDao extends JMBaseDao {
	
	public static final Area dao = new Area().dao();
	public static final String cacheName = "area";
	public static final String tableName = "tb_area";
	
	public List<Area> list(boolean useCache) {
		return list("",null,null,null,"id",JMBaseDao.DESC,useCache);
	} 
	
	public List<Area> list(String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, null, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Area> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Area> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, likepm, "", orderField, orderDirection, useCache);
	}
	
	public List<Area> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField,String orderDirection,boolean useCache) {
	...
	public List<Area> list(String sql,boolean useCache) {
		return list(tableName, dao, cacheName, sql, useCache);
	}
	
	public Page<Area> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String startTime,String endTime,String orderField,String orderDirection, boolean useCache) {
	...
	public Page<Area> page(int pageNumber, int pageSize,boolean useCache) {
		return page(pageNumber, pageSize, "", null, null, null, "", "id",DESC, useCache);
	}
	
	public Page<Area> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, null, null, orderField, orderDirection, useCache);
	}
	
	public Page<Area> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, null, orderField, orderDirection, useCache);
	}

	public Page<Area> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection, boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, likepm, "", orderField,orderDirection, useCache);
	}
	
	public Page<Area> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField, String orderDirection,boolean useCache) {
	...
	public Page<Area> page(int pageNumber, int pageSize,String columns,String where ,String orderField, String orderDirection,boolean useCache) {
		return page(tableName, dao, cacheName, pageNumber, pageSize, columns, where, orderField, orderDirection, useCache);
	}
	
	public Page<Area> page(int pageNumber, int pageSize,String columns,String from,boolean useCache) {
	...
	public Area getById(Integer id,boolean useCache) {
		return getById("", id, useCache);
	}
	
	@SuppressWarnings("unchecked")
	public Area getById(String columns,Integer id,boolean useCache) {
	...
	public Area get(HashMap<String, Object> param,boolean useCache) {
		return get("", param, useCache);
	}
	
	public Area get(String columns,HashMap<String, Object> param,boolean useCache) {
		StringBuffer format = new StringBuffer("SELECT ");
		if (JMToolString.isEmpty(columns)) {
			format.append(" * ");
		}else {
	...
	public Area get(String sql,boolean useCache) {
		if (useCache) {
	...
	public boolean save(Area area) {
		return Db.tx(new IAtom() {
			...
			public boolean run() throws SQLException {
				boolean result =  area.save();
				if (result) {
					clearCache();
					result = isave(area, result);
				}
				return result;
			}
		});
	...
	public boolean saves(List<Area> areaList) {
		int[] results = Db.use("base").batchSave(areaList, 2000);
		clearCache();
		return isaves(areaList, results);
	}
	...
	public boolean update(Area area) {
		return Db.tx(new IAtom() {
			@Override
			public boolean run() throws SQLException {
				boolean result =  area.update();
				if (result) {
					clearCache();
					result = iupdate(area, result);
				}
				return result;
			}
		});
	...
	public boolean updates(List<Area> areaList) {
		int[] results = Db.use("base").batchUpdate(areaList, 2000);
		clearCache();
		return iupdates(areaList, results);
	}


	public boolean delete(Area area) {
		return deleteById(area.getId());
	}
	...
	public boolean delete(List<Area> areaList) {
		if(areaList.isEmpty()){
			return false;
		}
		List<Integer> ids = new ArrayList<Integer>();
		for (int i = 0; i < areaList.size(); i++) {
			ids.add(areaList.get(i).getId());
		}
	...
	public List<Area> list(HashMap<String, Object> param,String orderDirection) {
		return list(param,"id",orderDirection);
	}

	public List<Area> list(HashMap<String, Object> param,String orderField,String orderDirection) {
