...
//	public JMAccountExpandDao expandDao ;
	...
	public Page<GoodsStar> pageByApi(int goodsId,int pageSize,int pageNumber){
		HashMap<String, Object> param = new HashMap<>();
		param.put("goodsId",goodsId);
		Page<GoodsStar> page = page(pageNumber, pageSize, "*", param, "id", "DESC",true);
		for(GoodsStar goodsStar : page.getList()){
			goodsStar.put("userInfo", accountUserService.selectByKeyAndValue("accountId =", goodsStar.getUserId()));
		}
		return page;
	}
	...
	public GoodsStar getByGoodsId(int goodsId){
		return JMToolSql.get(cacheName,new GoodsStar(),"select a.*,b.nick,b.head from shop_goods_star a inner join tb_account_user b on a.userId = b.accountId where goodsId = ? order by id desc", goodsId);
	}
