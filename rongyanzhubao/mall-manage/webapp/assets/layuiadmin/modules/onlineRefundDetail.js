  ...
  $.ajax({  
        ...
        success : function(data){
	      	...
	      	refundList.forEach((refund, index)=>{
		      	...
		      	refund.refundGoodsList.forEach(goods=>{
		      		trList+=`<tr>
			      			<td><div class="Lay-order-img">
				    		 	<img src="${ctx+goods.skuImg}?x-oss-process=image/resize,m_fill,h_200,w_200"/>
		      	...
		      	var handleHtml = refund.state == 0? `<a href="javascript:;" style="padding:20px 20px 20px 20px" onclick="handle(${jsonRefund})"><span class="canClick">同意/拒绝</span></a>`:'';
				            ...
				            <thead>
				                <tr>
				                  ...
				                  <th lay-data="{field:'num', width:100}">商品数量</th>
				                   <th lay-data="{field:'skuCode', width:100}">商品规格</th>
				                </tr> 
				              </thead>
				              <tbody>
				              		${trList}
