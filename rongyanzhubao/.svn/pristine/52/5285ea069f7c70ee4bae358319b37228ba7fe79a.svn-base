 ...
 */
public class NoticeDao extends JMBaseDao {
	
	public static final Notice dao = new Notice().dao();
	public static final String cacheName = "notice";
	public static final String tableName = "tb_notice";
	
	public List<Notice> list(boolean useCache) {
		return list("",null,null,null,"id",JMBaseDao.DESC,useCache);
	} 
	
	public List<Notice> list(String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, null, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Notice> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Notice> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, likepm, "", orderField, orderDirection, useCache);
	}
	
	public List<Notice> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField,String orderDirection,boolean useCache) {
	...
	public List<Notice> list(String sql,boolean useCache) {
		return list(tableName, dao, cacheName, sql, useCache);
	}
	
	public Page<Notice> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String startTime,String endTime,String orderField,String orderDirection, boolean useCache) {
	...
	public Page<Notice> page(int pageNumber, int pageSize,boolean useCache) {
		return page(pageNumber, pageSize, "", null, null, null, "", "id",DESC, useCache);
	}
	
	public Page<Notice> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, null, null, orderField, orderDirection, useCache);
	}
	
	public Page<Notice> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, null, orderField, orderDirection, useCache);
	}

	public Page<Notice> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection, boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, likepm, "", orderField,orderDirection, useCache);
	}
	
	public Page<Notice> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField, String orderDirection,boolean useCache) {
	...
	public Page<Notice> page(int pageNumber, int pageSize,String columns,String where ,String orderField, String orderDirection,boolean useCache) {
		return page(tableName, dao, cacheName, pageNumber, pageSize, columns, where, orderField, orderDirection, useCache);
	}
	
	public Page<Notice> page(int pageNumber, int pageSize,String columns,String from,boolean useCache) {
	...
	public Notice getById(Integer id,boolean useCache) {
		return getById("", id, useCache);
	}
	
	@SuppressWarnings("unchecked")
	public Notice getById(String columns,Integer id,boolean useCache) {
	...
	public Notice get(HashMap<String, Object> param,boolean useCache) {
		return get("", param, useCache);
	}
	
	public Notice get(String columns,HashMap<String, Object> param,boolean useCache) {
		StringBuffer format = new StringBuffer("SELECT ");
		if (JMToolString.isEmpty(columns)) {
			format.append(" * ");
		}else {
	...
	public Notice get(String sql,boolean useCache) {
		if (useCache) {
	...
	public boolean save(Notice notice) {
		return Db.tx(new IAtom() {
			...
			public boolean run() throws SQLException {
				boolean result =  notice.save();
				if (result) {
					clearCache();
					result = isave(notice, result);
				}
				return result;
			}
		});
	...
	public boolean saves(List<Notice> noticeList) {
		int[] results = Db.use("base").batchSave(noticeList, 2000);
		clearCache();
		return isaves(noticeList, results);
	}
	...
	public boolean update(Notice notice) {
		return Db.tx(new IAtom() {
			@Override
			public boolean run() throws SQLException {
				boolean result =  notice.update();
				if (result) {
					clearCache();
					result = iupdate(notice, result);
				}
				return result;
			}
		});
	...
	public boolean updates(List<Notice> noticeList) {
		int[] results = Db.use("base").batchUpdate(noticeList, 2000);
		clearCache();
		return iupdates(noticeList, results);
	}


	public boolean delete(Notice notice) {
		return deleteById(notice.getId());
	}
	...
	public boolean delete(List<Notice> noticeList) {
		if(noticeList.isEmpty()){
			return false;
		}
		List<Integer> ids = new ArrayList<Integer>();
		for (int i = 0; i < noticeList.size(); i++) {
			ids.add(noticeList.get(i).getId());
		}
	...
	public List<Notice> list(HashMap<String, Object> param,String orderDirection) {
		return list(param,"id",orderDirection);
	}

	public List<Notice> list(HashMap<String, Object> param,String orderField,String orderDirection) {
