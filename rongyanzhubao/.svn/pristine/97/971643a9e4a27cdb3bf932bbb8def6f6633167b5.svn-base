 ...
 */
public class LabelDao extends JMBaseDao {
	
	public static final Label dao = new Label().dao();
	public static final String cacheName = "label";
	public static final String tableName = "tb_label";
	
	public List<Label> list(boolean useCache) {
		return list("",null,null,null,"id",JMBaseDao.DESC,useCache);
	} 
	
	public List<Label> list(String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, null, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Label> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Label> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, likepm, "", orderField, orderDirection, useCache);
	}
	
	public List<Label> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField,String orderDirection,boolean useCache) {
	...
	public List<Label> list(String sql,boolean useCache) {
		return list(tableName, dao, cacheName, sql, useCache);
	}
	
	public Page<Label> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String startTime,String endTime,String orderField,String orderDirection, boolean useCache) {
	...
	public Page<Label> page(int pageNumber, int pageSize,boolean useCache) {
		return page(pageNumber, pageSize, "", null, null, null, "", "id",DESC, useCache);
	}
	
	public Page<Label> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, null, null, orderField, orderDirection, useCache);
	}
	
	public Page<Label> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, null, orderField, orderDirection, useCache);
	}

	public Page<Label> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection, boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, likepm, "", orderField,orderDirection, useCache);
	}
	
	public Page<Label> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField, String orderDirection,boolean useCache) {
	...
	public Page<Label> page(int pageNumber, int pageSize,String columns,String where ,String orderField, String orderDirection,boolean useCache) {
		return page(tableName, dao, cacheName, pageNumber, pageSize, columns, where, orderField, orderDirection, useCache);
	}
	
	public Page<Label> page(int pageNumber, int pageSize,String columns,String from,boolean useCache) {
	...
	public Label getById(Integer id,boolean useCache) {
		return getById("", id, useCache);
	}
	
	@SuppressWarnings("unchecked")
	public Label getById(String columns,Integer id,boolean useCache) {
	...
	public Label get(HashMap<String, Object> param,boolean useCache) {
		return get("", param, useCache);
	}
	
	public Label get(String columns,HashMap<String, Object> param,boolean useCache) {
		StringBuffer format = new StringBuffer("SELECT ");
		if (JMToolString.isEmpty(columns)) {
			format.append(" * ");
		}else {
	...
	public Label get(String sql,boolean useCache) {
		if (useCache) {
	...
	public boolean save(Label label) {
		return Db.tx(new IAtom() {
			...
			public boolean run() throws SQLException {
				boolean result =  label.save();
				if (result) {
					clearCache();
					result = isave(label, result);
				}
				return result;
			}
		});
	...
	public boolean saves(List<Label> labelList) {
		int[] results = Db.use("base").batchSave(labelList, 2000);
		clearCache();
		return isaves(labelList, results);
	}
	...
	public boolean update(Label label) {
		return Db.tx(new IAtom() {
			@Override
			public boolean run() throws SQLException {
				boolean result =  label.update();
				if (result) {
					clearCache();
					result = iupdate(label, result);
				}
				return result;
			}
		});
	...
	public boolean updates(List<Label> labelList) {
		int[] results = Db.use("base").batchUpdate(labelList, 2000);
		clearCache();
		return iupdates(labelList, results);
	}


	public boolean delete(Label label) {
		return deleteById(label.getId());
	}
	...
	public boolean delete(List<Label> labelList) {
		if(labelList.isEmpty()){
			return false;
		}
		List<Integer> ids = new ArrayList<Integer>();
		for (int i = 0; i < labelList.size(); i++) {
			ids.add(labelList.get(i).getId());
		}
	...
	public List<Label> list(HashMap<String, Object> param,String orderDirection) {
		return list(param,"id",orderDirection);
	}

	public List<Label> list(HashMap<String, Object> param,String orderField,String orderDirection) {
