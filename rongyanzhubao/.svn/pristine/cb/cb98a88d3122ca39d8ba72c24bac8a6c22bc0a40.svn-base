 ...
 */
public class CashDao extends JMBaseDao {
	
	public static final Cash dao = new Cash().dao();
	public static final String cacheName = "cash";
	public static final String tableName = "shop_cash";
	
	public List<Cash> list(boolean useCache) {
		return list("",null,null,null,"id",JMBaseDao.DESC,useCache);
	} 
	
	public List<Cash> list(String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, null, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Cash> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Cash> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, likepm, "", orderField, orderDirection, useCache);
	}
	
	public List<Cash> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField,String orderDirection,boolean useCache) {
	...
	public List<Cash> list(String sql,boolean useCache) {
		return list(tableName, dao, cacheName, sql, useCache);
	}
	
	public Page<Cash> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String startTime,String endTime,String orderField,String orderDirection, boolean useCache) {
	...
	public Page<Cash> page(int pageNumber, int pageSize,boolean useCache) {
		return page(pageNumber, pageSize, "", null, null, null, "", "id",DESC, useCache);
	}
	
	public Page<Cash> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, null, null, orderField, orderDirection, useCache);
	}
	
	public Page<Cash> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, null, orderField, orderDirection, useCache);
	}

	public Page<Cash> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection, boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, likepm, "", orderField,orderDirection, useCache);
	}
	
	public Page<Cash> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField, String orderDirection,boolean useCache) {
	...
	public Page<Cash> page(int pageNumber, int pageSize,String columns,String where ,String orderField, String orderDirection,boolean useCache) {
		return page(tableName, dao, cacheName, pageNumber, pageSize, columns, where, orderField, orderDirection, useCache);
	}
	
	public Page<Cash> page(int pageNumber, int pageSize,String columns,String from,boolean useCache) {
	...
	public Cash getById(Integer id,boolean useCache) {
		return getById("", id, useCache);
	}
	
	@SuppressWarnings("unchecked")
	public Cash getById(String columns,Integer id,boolean useCache) {
	...
	public Cash get(HashMap<String, Object> param,boolean useCache) {
		return get("", param, useCache);
	}
	
	public Cash get(String columns,HashMap<String, Object> param,boolean useCache) {
		StringBuffer format = new StringBuffer("SELECT ");
		if (JMToolString.isEmpty(columns)) {
			format.append(" * ");
		}else {
	...
	public Cash get(String sql,boolean useCache) {
		if (useCache) {
	...
	public boolean save(Cash cash) {
		return Db.tx(new IAtom() {
			...
			public boolean run() throws SQLException {
				boolean result =  cash.save();
				if (result) {
					clearCache();
					result = isave(cash, result);
				}
				return result;
			}
		});
	...
	public boolean saves(List<Cash> cashList) {
		int[] results = Db.use("base").batchSave(cashList, 2000);
		clearCache();
		return isaves(cashList, results);
	}
	...
	public boolean update(Cash cash) {
		return Db.tx(new IAtom() {
			@Override
			public boolean run() throws SQLException {
				boolean result =  cash.update();
				if (result) {
					clearCache();
					result = iupdate(cash, result);
				}
				return result;
			}
		});
	...
	public boolean updates(List<Cash> cashList) {
		int[] results = Db.use("base").batchUpdate(cashList, 2000);
		clearCache();
		return iupdates(cashList, results);
	}


	public boolean delete(Cash cash) {
		return deleteById(cash.getId());
	}
	...
	public boolean delete(List<Cash> cashList) {
		if(cashList.isEmpty()){
			return false;
		}
		List<Integer> ids = new ArrayList<Integer>();
		for (int i = 0; i < cashList.size(); i++) {
			ids.add(cashList.get(i).getId());
		}
	...
	public List<Cash> list(HashMap<String, Object> param,String orderDirection) {
		return list(param,"id",orderDirection);
	}

	public List<Cash> list(HashMap<String, Object> param,String orderField,String orderDirection) {
