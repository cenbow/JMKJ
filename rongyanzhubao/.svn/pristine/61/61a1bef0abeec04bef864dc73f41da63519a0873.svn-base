...
public class JMRoomManagementDao extends RoomManagementDao{
	...
	public Room selectMyAnchorRoom(Account account) {
		Query query = new Query();
		query.put("and manageAccountId=", account.getId());
		String select = "select r.*,c.head,c.nick";
		String inner = "r inner join webcast_room_merchant a on a.anchorAccountId = r.accountId"
				+ " inner join webcast_room_management b on b.merchantAccountId = a.merchantAccountId"
				+ " inner join tb_account_user c on c.accountId = r.accountId";
