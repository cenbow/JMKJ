...
public class FollowDao extends JMBaseDao {
	
	public static final Follow dao = new Follow().dao();
	public static final String cacheName = "follow";
	public static final String tableName = "tb_follow";
	
	public List<Follow> list(boolean useCache) {
		return list("",null,null,null,"id",JMBaseDao.DESC,useCache);
	} 
	
	public List<Follow> list(String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, null, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Follow> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Follow> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, likepm, "", orderField, orderDirection, useCache);
	}
	
	public List<Follow> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField,String orderDirection,boolean useCache) {
	...
	public List<Follow> list(String sql,boolean useCache) {
		return list(tableName, dao, cacheName, sql, useCache);
	}
	
	public Page<Follow> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String startTime,String endTime,String orderField,String orderDirection, boolean useCache) {
	...
	public Page<Follow> page(int pageNumber, int pageSize,boolean useCache) {
		return page(pageNumber, pageSize, "", null, null, null, "", "id",DESC, useCache);
	}
	
	public Page<Follow> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, null, null, orderField, orderDirection, useCache);
	}
	
	public Page<Follow> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, null, orderField, orderDirection, useCache);
	}

	public Page<Follow> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection, boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, likepm, "", orderField,orderDirection, useCache);
	}
	
	public Page<Follow> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField, String orderDirection,boolean useCache) {
	...
	public Page<Follow> page(int pageNumber, int pageSize,String columns,String where ,String orderField, String orderDirection,boolean useCache) {
		return page(tableName, dao, cacheName, pageNumber, pageSize, columns, where, orderField, orderDirection, useCache);
	}
	
	public Page<Follow> page(int pageNumber, int pageSize,String columns,String from,boolean useCache) {
	...
	public Follow getById(Integer id,boolean useCache) {
		return getById("", id, useCache);
	}
	
	public Follow getById(String columns,Integer id,boolean useCache) {
	...
	public Follow get(HashMap<String, Object> param,boolean useCache) {
		return get("", param, useCache);
	}
	
	public Follow get(String columns,HashMap<String, Object> param,boolean useCache) {
		StringBuffer format = new StringBuffer("SELECT ");
		if (JMToolString.isEmpty(columns)) {
			format.append(" * ");
		}else {
	...
	public Follow get(String sql,boolean useCache) {
		if (useCache) {
	...
	public boolean save(Follow follow) {
		return Db.tx(new IAtom() {
			...
			public boolean run() throws SQLException {
				boolean result =  follow.save();
				if (result) {
					clearCache();
					result = isave(follow, result);
				}
				return result;
			}
		});
	...
	public boolean saves(List<Follow> followList) {
		int[] results = Db.use("base").batchSave(followList, 2000);
		clearCache();
		return isaves(followList, results);
	}
	...
	public boolean update(Follow follow) {
		return Db.tx(new IAtom() {
			@Override
			public boolean run() throws SQLException {
				boolean result =  follow.update();
				if (result) {
					clearCache();
					result = iupdate(follow, result);
				}
				return result;
			}
		});
	...
	public boolean updates(List<Follow> followList) {
		int[] results = Db.use("base").batchUpdate(followList, 2000);
		clearCache();
		return iupdates(followList, results);
	}
	...
	public boolean delete(List<Follow> followList) {
		if(followList.isEmpty()){
			return false;
		}
		List<Integer> ids = new ArrayList<Integer>();
		for (int i = 0; i < followList.size(); i++) {
			ids.add(followList.get(i).getId());
		}
	...
	public List<Follow> list(HashMap<String, Object> param,String orderDirection) {
		return list(param,"id",orderDirection);
	}

	public List<Follow> list(HashMap<String, Object> param,String orderField,String orderDirection) {
