 ...
 */
public class AddressDao extends JMBaseDao {
	
	public static final Address dao = new Address().dao();
	public static final String cacheName = "address";
	public static final String tableName = "shop_address";
	
	public List<Address> list(boolean useCache) {
		return list("",null,null,null,"id",JMBaseDao.DESC,useCache);
	} 
	
	public List<Address> list(String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, null, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Address> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, null, "", orderField, orderDirection, useCache);
	}
	
	public List<Address> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection,boolean useCache) {
		return list(columns, andpm, orpm, likepm, "", orderField, orderDirection, useCache);
	}
	
	public List<Address> list(String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField,String orderDirection,boolean useCache) {
	...
	public List<Address> list(String sql,boolean useCache) {
		return list(tableName, dao, cacheName, sql, useCache);
	}
	
	public Page<Address> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String startTime,String endTime,String orderField,String orderDirection, boolean useCache) {
	...
	public Page<Address> page(int pageNumber, int pageSize,boolean useCache) {
		return page(pageNumber, pageSize, "", null, null, null, "", "id",DESC, useCache);
	}
	
	public Page<Address> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, null, null, orderField, orderDirection, useCache);
	}
	
	public Page<Address> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,String orderField,String orderDirection,boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, null, orderField, orderDirection, useCache);
	}

	public Page<Address> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String orderField,String orderDirection, boolean useCache) {
		return page(pageNumber, pageSize, columns, andpm, orpm, likepm, "", orderField,orderDirection, useCache);
	}
	
	public Page<Address> page(int pageNumber, int pageSize,String columns,HashMap<String, Object> andpm,HashMap<String, Object> orpm,HashMap<String, Object> likepm,String appendSql,String orderField, String orderDirection,boolean useCache) {
	...
	public Page<Address> page(int pageNumber, int pageSize,String columns,String where ,String orderField, String orderDirection,boolean useCache) {
		return page(tableName, dao, cacheName, pageNumber, pageSize, columns, where, orderField, orderDirection, useCache);
	}
	
	public Page<Address> page(int pageNumber, int pageSize,String columns,String from,boolean useCache) {
	...
	public Address getById(Integer id,boolean useCache) {
		return getById("", id, useCache);
	}
	
	@SuppressWarnings("unchecked")
	public Address getById(String columns,Integer id,boolean useCache) {
	...
	public Address get(HashMap<String, Object> param,boolean useCache) {
		return get("", param, useCache);
	}
	
	public Address get(String columns,HashMap<String, Object> param,boolean useCache) {
		StringBuffer format = new StringBuffer("SELECT ");
		if (JMToolString.isEmpty(columns)) {
			format.append(" * ");
		}else {
	...
	public Address get(String sql,boolean useCache) {
		if (useCache) {
	...
	public boolean save(Address address) {
		return Db.tx(new IAtom() {
			...
			public boolean run() throws SQLException {
				boolean result =  address.save();
				if (result) {
					clearCache();
					result = isave(address, result);
				}
				return result;
			}
		});
	...
	public boolean saves(List<Address> addressList) {
		int[] results = Db.use("base").batchSave(addressList, 2000);
		clearCache();
		return isaves(addressList, results);
	}
	...
	public boolean update(Address address) {
		return Db.tx(new IAtom() {
			@Override
			public boolean run() throws SQLException {
				boolean result =  address.update();
				if (result) {
					clearCache();
					result = iupdate(address, result);
				}
				return result;
			}
		});
	...
	public boolean updates(List<Address> addressList) {
		int[] results = Db.use("base").batchUpdate(addressList, 2000);
		clearCache();
		return iupdates(addressList, results);
	}
	...
	public boolean delete(List<Address> addressList) {
		...
		for (int i = 0; i < addressList.size(); i++) {
			ids.add(addressList.get(i).getId());
		}
	...
	public List<Address> list(HashMap<String, Object> param,String orderDirection) {
		return list(param,"id",orderDirection);
	}

	public List<Address> list(HashMap<String, Object> param,String orderField,String orderDirection) {
